  ...
  return (
    <div className="flex flex-col gap-2">
      ...
      <div
        ...
        className={`
          relative w-full aspect-square max-w-xs mx-auto rounded-2xl border-2 border-dashed
          flex flex-col items-center justify-center gap-2 cursor-pointer
          transition-colors hover:bg-gray-50 active:bg-gray-100
          ${displaySrc ? "border-gray-300" : "border-gray-300"}
        `}
      >
        {displaySrc ? (
          <img
          ...
          <>
            ...
            <span className="text-sm text-gray-500">{t("common.uploadPhoto")}</span>
          </>
        )}
